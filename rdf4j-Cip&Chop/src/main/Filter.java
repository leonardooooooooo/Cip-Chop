...
public class Filter {
	...
	public static void main(String[] args) throws IOException {
		...
		InputStream input = Filter.class.getResourceAsStream("/" + filename);
		...
		IRI leo = vf.createIRI("http://example.org/Leonardo");
		...
		Model aboutLeo = model.filter(leo, null, null);

		// Iterate over the statements that are about Van Gogh
		for (Statement st: aboutLeo) {
